...
//                     <Card className="cursor-pointer hover:shadow-lg transition-all duration-300 prediction-card border-2 border-transparent hover:border-blue-200">
...
//                     <Card className="cursor-pointer hover:shadow-lg transition-all duration-300 prediction-card border-2 border-transparent hover:border-green-200">
//                       <CardContent className="p-6 text-center">
